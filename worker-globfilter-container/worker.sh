...
cd /maven
exec java $CAF_WORKER_JAVA_OPTS -cp "*:/mnt/mesos/sandbox/*:/mnt/mesos/sandbox/batch-plugins/*" com.github.workerframework.core.WorkerApplication server ${dropwizardConfig}
